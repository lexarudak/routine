...
*Для использования приложения в режиме инкогнито, необходимо разрешить использование cookie в настройках браузера, т.к. приложение использует cookie-аутентификацию.*
