...
- Логин и регистрация (максимальный балл - 50).
...
- Страница личного кабинета (максимальный балл - 30).
    ...
    - Реализован пблок с настройками. Можно изменить день подтверждения, время напоминания, имя пользователя, а также можно разлогиниться. (10 баллов)
    - После изменения настроек появляется пульсирующая кнопка сохранения. После сохранения кнопка пропадает (5 баллво)
    - На странице. отображается статистика, показывающая на сколько минут в день в среднем выполнение плана отклоняется от запланированного времени. Планы сортируются по соответствующим столбцам (10 баллов)
