...
- Часы
	...
	- Нажатие на AM-PM меняет график с задачами в соответствии с выбранным временем суток (после отведения курсора мыши с блока с часами значение и график возвращается к актуальному на данное время) (5 баллов)
...
- Есть полоса с графическим отображением заполнения недели. Шкала заполняется от большего к меньшему и имеет реальные пропорции (10 баллов)
...
- Время плана можно увеличить и уменьшить. Нельзя уменьшить больше, чем на свободное время в текущем дне (которое не находится на шкале времени). Нельзя увеличить больше, чем на свободное время плана со страницы недели. (5 баллов)
...
- Таймлайн (на чистом JS без библиотек)
	...
	- Можно «выбросить» план из таймлайна просто вытянув его (10 баллов)
	- Можно перемещать план по таймлайну перетягиванием (20 баллов)
...
- На странице недели при создании нового плана, если закрыть popup, то его текст и имя сохраняются в local Storage и восстанавливаются при следующем открытии (5 баллов)
...
- Есть страница логина и регистрации. Переключение между ними плавное, с сохранением введенных данных (10 баллов)
...
- Формы (за все формы 20 баллов)
	...
	- Есть стилизованный input, меняющий срок действия токена с 1 дня на 7 дней 
...
- Приложение выполнено как SPA и работает без перезагрузки страницы (5 баллов)
- Можно попасть на любую из существующих страниц введя ее адрес в строку поиска (5 баллов)
